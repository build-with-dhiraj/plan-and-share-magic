...
// Stubbed: PYQ tables not yet created in database.
// All functions return empty data gracefully.
// ═══════════════════════════════════════════
...
// All functions below are stubs — PYQ tables will be created later
